...
export const submit = createAction(
  SUBMIT,
  (resolve) => (params: { complexity: number }) =>
    resolve({ complexity: params.complexity })
);
...
export const cancel = createAction(
  CANCEL,
  (resolve) => (params: { id: number }) => resolve({ id: params.id })
);

export const updateStatus = createAction(
  UPDATE_STATUS,
  (resolve) => (params: { id: number; status: Status }) =>
